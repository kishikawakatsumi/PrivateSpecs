Pod::Spec.new do |s|
  ...
  s.module_map              = 'OpenSSL/OpenSSL.modulemap'
  s.prepare_command       = <<-CMD
                              mkdir OpenSSL
                              echo 'framework module OpenSSL {' > OpenSSL/OpenSSL.modulemap
                              echo '  umbrella header "OpenSSL.h"' >> OpenSSL/OpenSSL.modulemap
                              echo '  link "ssl"' >> OpenSSL/OpenSSL.modulemap
                              echo '  link "crypto"' >> OpenSSL/OpenSSL.modulemap
                              echo '  export *' >> OpenSSL/OpenSSL.modulemap
                              echo '  module * { export * }' >> OpenSSL/OpenSSL.modulemap
                              echo '}' >> OpenSSL/OpenSSL.modulemap
                            CMD
end
